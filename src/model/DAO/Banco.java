...
public class Banco {
    ...
    public static void inicia(){
        ...
        Agendamento agendamento1 = new Agendamento(cliente1, servico1, 30, "14/07/2018 09:30");
        Agendamento agendamento2 = new Agendamento(cliente3, servico2, 40, "14/07/2018 10:00");
        Agendamento agendamento3 = new Agendamento(cliente3, servico3, 18, "14/07/2018 10:30");
